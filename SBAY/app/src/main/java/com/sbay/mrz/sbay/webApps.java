 ...
 */
public class webApps extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_web_apps, container, false);
    ...
    private void getSoftwares(){
        ...
        Call<List<softwareDetails>> softwareDetalisListCall = apiInterface.webApps();
